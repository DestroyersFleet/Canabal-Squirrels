...
MAXHEALTH = 6        # how much health the player starts with

NUMGRASS = 300        # number of grass objects in the active area
NUMSQUIRRELS = 100    # number of squirrels in the active area
SQUIRRELMINSPEED = 3 # slowest squirrel speed
SQUIRRELAVGSPEED = 7 # average squirrel speed
SQUIRRELMAXSPEED = 11 # fastest squirrel speed
...
def main():
    global FPSCLOCK, DISPLAYSURF, BASICFONT, L_SQUIR_IMG, R_SQUIR_IMG, L_LSQUIR_IMG, R_LSQUIR_IMG, GRASSIMAGES

    pygame.init()
    FPSCLOCK = pygame.time.Clock()
    pygame.display.set_icon(pygame.image.load('gameicon.png'))
    DISPLAYSURF = pygame.display.set_mode((WINWIDTH, WINHEIGHT))
    pygame.display.set_caption('Squirrel Eat Squirrels')
